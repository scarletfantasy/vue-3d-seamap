<template>
  <div id="maindiv">
    ...
    <script id="groundfragment1" type="x-shader/x-fragment">
      ...
      void main()
      {
        float dis=length(wpos-cameraPosition)/20.0;

        gl_FragColor = vec4(texture(tex,texcoord).xyz*seaheight*10.0f,1.0);
      }
  </script>
...
export default {
  ...
  methods: {
    ...
    generatesurface()
    {
      ...
      let geometry=new Three.PlaneGeometry(10.0,10.0,100,20)
